...
public class UDFAES128Encrypt extends GenericUDF{
	...
	public Object evaluate(DeferredObject[] arg0) throws HiveException {
		...
		try {	
			...
			byte[][] keySpecs = Utils.createKeyAndIv(Utils.hexStringToByteArray(arg0[1].get().toString()),16);
			// Create SecretKey
	...
	public String getDisplayString(String[] arg0) {
		return "AES/CBC/PKCS5Padding with 128 bit";
	}
}
