...
public class UDFAES128Decrypt extends GenericUDF{
	
	@Override
	public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
		 if (arguments.length != 2) {
			  throw new UDFArgumentException("input must have length 2 at least.");
	     }
		 //Primitive string
	...
	public Object evaluate(DeferredObject[] arg0) throws HiveException {
		try {
			...
			byte[][] keySpecs = Utils.createKeyAndIv(Utils.hexStringToByteArray(key),16);
			// Create SecretKey
	...
	public String getDisplayString(String[] arg0) {
		return "Returns the decrypted value of a hex string. Encoded with AES128/CBC/PKCS5Padding.";
	}
}
